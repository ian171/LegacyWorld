...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context,ZINC_ORE_PLACED_KEY,configuredFeatures.getOrThrow(ModConfiguredFeatures.ZINK), ModOrePlacement.modifiersWithCount(14, HeightRangePlacementModifier.uniform(YOffset.fixed(-80),YOffset.fixed(80))));
    }
