package net.chen.entity.custom;
...
public class MantisEntity extends AnimalEntity {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        ...
        MantisVariant mantisVariant = Util.getRandom(MantisVariant.values(), this.random);
        setVariant(mantisVariant);
    ...
    public MantisVariant getVariant(){
        return MantisVariant.byId(this.getVariantType() & 255);
    }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.putInt("Variant", this.getVariantType());
    }
