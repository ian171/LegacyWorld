...
import net.chen.blocks.devices.ChairBlock;
...
public class ModBlock {
    ...
    public static final Block IRON_ORE = register("iron_ore", new IronOre(AbstractBlock.Settings.create().mapColor(DyeColor.CYAN).strength(3.0f, 3.0f).nonOpaque()));
    ...
    public static final Block LEAD_ORE = register("lead_ore", new Block(AbstractBlock.Settings.create().mapColor(DyeColor.GRAY).strength(3.0f, 3.0f).requiresTool()));
    public static final Block SILVER_ORE = register("silver_ore", new Block(AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_GRAY).strength(3.0f, 3.0f).requiresTool()));
    public static final Block TUNGSTEN_ORE = register("tungsten_ore", new Block(AbstractBlock.Settings.create().mapColor(DyeColor.BLACK).strength(5.0f, 6.0f).requiresTool()));
    public static final Block COBALT_ORE = register("cobalt_ore", new Block(AbstractBlock.Settings.create().mapColor(DyeColor.BLUE).strength(3.0f, 3.0f).requiresTool()));
    ...
    public static final Block CHAIR = register("chair", new ChairBlock(AbstractBlock.Settings.create().nonOpaque()));
